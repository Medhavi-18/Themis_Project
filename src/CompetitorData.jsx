...
const CompetitorData = () => {
  ...
  const rows = [
    "RCC ACTIVE", "THEMIBACT 250/500", "THEMIBACT CV 250/500", "ETOJET 120/90", "Etojet XP Gel", "Etojet-MR Tablets", "FEREDET XT", "GENPRO D", "GENPRO GEL", "GENPRO SR 200/300", "MENOGARD", "OSTEOWIN"
          ...
          <tbody>
            {rows.map((rowLabel, index) => (
              <tr key={index}>
                ...
                <td className="border px-4 py-2">
                  {prescribed[index] === true ? <input type="number" className="border p-1 w-full" /> : null}
                </td>
                <td className="border px-4 py-2">
                  {prescribed[index] === true ? <input type="text" className="border p-1 w-full" /> : null}
                </td>
                <td className="border px-4 py-2">
                  {prescribed[index] === true ? <input type="number" className="border p-1 w-full" /> : null}
                </td>
